...
/*
        System.out.println(test.root.d.toString());         //root is set properly
        System.out.println(R.toString());                   //theses 2 match here move on
        System.out.println(test.root.younger.toString());   //set properly
        System.out.println(S.toString());                   //these match
        System.out.println(test.root.older.toString());
...
*/
    ...
    private static void testShelter2() {
        ...
        test.shelter(P2);
/*
        System.out.println("CHECKING DOGS");
        System.out.println("\nRoot");
        System.out.println(test.root.d.toString()); //good
        System.out.println(R.toString());
        System.out.println("root.younger");
        System.out.println(test.root.younger.d.toString()); //bad
        System.out.println(L.toString());
        System.out.println("root.younger.older");
        System.out.println(test.root.younger.older.d.toString());   //good
        System.out.println(P2.toString());
        System.out.println("root.younger.older.younger");
        System.out.println(test.root.younger.older.younger.d.toString());   //good
        System.out.println(S.toString());
        System.out.println("CHECKING PARENTS");
        System.out.println("root.younger.parent");
        System.out.println(test.root.younger.parent.d.toString());  //good
        System.out.println(R.toString());
        System.out.println("root.younger.older.parent");
        System.out.println(test.root.younger.older.parent.d.toString());   //bad
        System.out.println(L.toString());
        System.out.println("root.younger.older.younger.parent");
        System.out.println(test.root.younger.older.younger.parent.d.toString()); //bad
        System.out.println(P2.toString());
        System.out.println("CHECKING NULLS");
        System.out.println(test.root.parent == null);//true
        System.out.println(test.root.older == null); // true
        System.out.println(test.root.younger.younger == null); //true
        System.out.println(test.root.younger.older.older == null); //TRUE
        System.out.println(test.root.younger.older.younger.younger == null); //true
        System.out.println(test.root.younger.older.younger.older == null); //false
*/
...
/*
        System.out.println("\nRoot");
        System.out.println(test.root.d.toString());
        System.out.println(R.toString());
        System.out.println("root.younger");
        System.out.println(test.root.younger.d.toString());
        System.out.println(L.toString());
        System.out.println("root.younger.older");
        System.out.println(test.root.younger.older.d.toString());
        System.out.println(S.toString());
        System.out.println("***testing parents***");
        System.out.println("root.younger.parent");
        System.out.println(test.root.younger.parent.d.toString());
        System.out.println(R.toString());
        System.out.println("root.younger.older.parent");
        System.out.println(test.root.younger.older.parent.d.toString());
        System.out.println(L.toString());
*/
